...
def game_over():
    ...
    game_over_rect = game_over_surface.get_rect(center=(dis_width // 2, dis_height // 2))  # Solve of the You Lost! text problem was actually here lol
...
while True:
    ...
    snake_body.insert(0, list(snake_pos))  # Add the new head to the beginning of the body
