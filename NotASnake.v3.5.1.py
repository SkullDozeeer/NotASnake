...
pygame.display.set_caption("NotASnake v3.5.1 | Thanks for playing!")
...
def show_score(choice, color, font, size, score1=None, score2=None, game_start_ms=None):
    ...
    if choice == 1:
        ...
        if score2 is None:
            score_text = f"NotASnake v3.5.1 | End Score: {score1}"
            score_surface = score_font.render(score_text, True, txt_color)
            screen.blit(score_surface, (SCREEN_WIDTH//2 - 250, SCREEN_HEIGHT * 4 // 5))
        else:
            score_text = f"NotASnake v3.5.1 | How cool! Two guys playing! | P1: {score1} | P2: {score2}"
            score_surface = score_font.render(score_text, True, txt_color)
...
def deathmatch_game():
    ...
    while True:
        ...
        version_str = "NotASnake v3.5.1  [DEATHMATCH]"
...
def main_menu():
    ...
    while True:
        ...
        title_surface = render_fit("title", "NotASnake v3.5.1", COLORS["green"], title_max_w, 100, min_size=40)
